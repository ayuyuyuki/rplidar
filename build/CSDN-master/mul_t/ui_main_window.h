...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        MainWindowDesign->resize(649, 479);
        QIcon icon;
        ...
        gridLayout_3->addWidget(label_camera, 0, 0, 1, 1);
        ...
        dock_status->setAccessibleName(QString::fromUtf8(""));
#endif // QT_NO_ACCESSIBILITY
        dock_status->setLocale(QLocale(QLocale::Chinese, QLocale::China));
        dock_status->setFloating(true);
        dock_status->setAllowedAreas(Qt::LeftDockWidgetArea);
        ...
        lineEdit_listener = new QLineEdit(frame);
        lineEdit_listener->setObjectName(QString::fromUtf8("lineEdit_listener"));

        verticalLayout_3->addWidget(lineEdit_listener);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        label_camera->setText(QApplication::translate("MainWindowDesign", "CameraLabel", 0, QApplication::UnicodeUTF8));
