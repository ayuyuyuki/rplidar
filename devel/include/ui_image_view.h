...
public:
    ...
    void setupUi(QWidget *ImageViewWidget)
    {
        ...
        ImageViewWidget->resize(481, 333);
        ...
        pushButton = new QPushButton(ImageViewWidget);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 479, 212));
        ...
        image_frame->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
    ...
    void retranslateUi(QWidget *ImageViewWidget)
    {
        ...
        refresh_topics_push_button->setToolTip(QApplication::translate("ImageViewWidget", "Refresh topics", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        zoom_1_push_button->setToolTip(QApplication::translate("ImageViewWidget", "Original zoom", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        num_gridlines_spin_box->setToolTip(QApplication::translate("ImageViewWidget", "# of gridlines to overlay", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        smooth_image_check_box->setToolTip(QApplication::translate("ImageViewWidget", "Dynamic depth range", 0));
#endif // QT_NO_TOOLTIP
        smooth_image_check_box->setText(QApplication::translate("ImageViewWidget", "Smooth scaling", 0));
        rotate_left_push_button->setText(QString());
        rotate_label->setText(QApplication::translate("ImageViewWidget", "0\302\260", 0));
        rotate_right_push_button->setText(QString());
        pushButton->setText(QApplication::translate("ImageViewWidget", "PushButton", 0));
    } // retranslateUi
